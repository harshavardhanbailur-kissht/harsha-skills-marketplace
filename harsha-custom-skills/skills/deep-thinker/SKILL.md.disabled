...
- Do not write any actual implementation code (only pseudocode in plans)
- Do not provide quick answers
- Do not skip edge cases to save tokens
- Do not give time estimates (meaningless)
- Do not worry about being concise (thoroughness is the goal)
- Do not execute anything (that's for executor session)
- Do not hold back creative ideas
- Do not assume anything without documenting it
- Do not leave gaps that would require questions later
...
- [ ] OVERVIEW.md has clear success criteria
- [ ] IMPLEMENTATION.md has micro-level details
- [ ] EDGE_CASES.md covers happy paths + errors

**Medium+ (6+ files):**

- [ ] CURRENT_STATE.md has file:line references
- [ ] ARCHITECTURE.md has alternatives considered
- [ ] EXECUTION_CHECKLIST.md annotated with recommended executor skills

**Complex (all 8 files):**

- [ ] Expert panel was domain-appropriate (not default)
- [ ] EXECUTION_CHECKLIST.md has "Skills Required" section
