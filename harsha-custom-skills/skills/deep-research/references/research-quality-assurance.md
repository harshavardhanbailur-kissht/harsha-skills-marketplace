...
Use these exact definitions to ensure consistency:

### HIGH Confidence
**Definition**: Multiple authoritative sources agree; methodology is sound; information is recent.

**Criteria**:
- 2+ Tier 1-2 sources all agreeing
...
**Example**:
"Cotton production consumes approximately 2,700 liters of water per shirt, as documented by the UN Environment Programme (2024) and confirmed by the Water Footprint Network research."

**Use**: Front-and-center statements, confidence assertions

### MEDIUM Confidence
**Definition**: Some sources support the claim, but with limitations (weak authority, age, narrow scope).
...
- Limited replication or single study results

**Example**:
"Some evidence suggests that blockchain technology could improve supply chain transparency in fashion, though real-world implementations remain limited."

**Use**: Emerging topics, limited research, nuanced claims

### LOW Confidence
**Definition**: Limited sources, conflicting evidence, weak authority, or significant limitations.

**Criteria**:
- Single Tier 2 source OR conflicting Tier 1-2 sources
- Only Tier 3-4 sources available
- >3 years old with no recent updates
- Significant methodology limitations noted
- Not replicated or contradicted by recent research

**Example**:
"Some fashion brands claim that 'sustainable' fast fashion is possible, though environmental groups dispute this assertion."

**Use**: Controversial topics, early-stage claims, community perspectives

### UNKNOWN Confidence
**Definition**: Insufficient reliable information to assess accuracy.

**Criteria**:
- No sources found despite thorough search
- All available sources are Tier 4 (unverified)
- Claim is entirely speculative with no supporting evidence
- Topic too new/niche for any reliable sources

**Example**:
"The long-term impact of quantum computing on textile manufacturing remains unknown; no peer-reviewed research is currently available."

**Use**: Knowledge gaps, future predictions, unexplored areas
