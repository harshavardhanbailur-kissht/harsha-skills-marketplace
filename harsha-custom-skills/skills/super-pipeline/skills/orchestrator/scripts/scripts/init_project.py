...
def create_directory_structure(base_path: Path):
    """Create the orchestrator AND parallel directory structures"""
    # .orchestrator/ — our persistent state
    orchestrator_dirs = [
        base_path,
        base_path / "checkpoints",
        base_path / "knowledge",
        base_path / "knowledge" / "adr",
        base_path / "knowledge" / "failures",
        base_path / "knowledge" / "research",
        base_path / "backups"
    ]

    # .parallel/ — output for parallel-skill-builder
    parallel_base = base_path.parent / ".parallel"
    parallel_dirs = [
        parallel_base,
        parallel_base / "prompts",
        parallel_base / "contracts",
        parallel_base / "outputs",
        parallel_base / "reports"
    ]

    for directory in orchestrator_dirs + parallel_dirs:
